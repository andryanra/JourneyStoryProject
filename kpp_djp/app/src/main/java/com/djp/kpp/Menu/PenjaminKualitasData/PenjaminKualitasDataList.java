...
import com.djp.kpp.Menu.CaptureData.CaptureDataDetail;
...
public class PenjaminKualitasDataList extends AppCompatActivity {

    ListView list;
    ProgressBar progressBar;
    TextView kosong;
    List<CaptureDataModel> listdata = new ArrayList<>();
    PenjaminKualitasDataAdapter adapter;
    String getToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul.setText("Penjamin Kualitas Data");
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Koneksi.pkd, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            adapter = new PenjaminKualitasDataAdapter(getApplicationContext(), listdata);
                            ...
                            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Intent in = new Intent(PenjaminKualitasDataList.this, PenjaminKualitasDataDetail.class);
