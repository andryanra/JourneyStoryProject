...
public class MDataPengamatan extends AppCompatActivity {

    ListView list;
    ProgressBar progressBar;
    TextView kosong;
    List<MonitoringModel> listdata = new ArrayList<>();
    DataPengamatanAdapter adapter;
    String getToken;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_m_data_pengamatan);
    ...
    private void getData() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Koneksi.monitoring_pengamatan, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            adapter = new DataPengamatanAdapter(getApplicationContext(), listdata);
