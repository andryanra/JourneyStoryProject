...
public class MTL_PKD_Adapter extends ArrayAdapter<MonitoringModel> {

    Context context;
    List<MonitoringModel> list;


    public MTL_PKD_Adapter(Context context, List<MonitoringModel> objects) {

        super(context, R.layout.row_m_tl_pkd, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.row_m_tl_pkd, null);
