...
public class PenjaminKualitasDataAdapter extends ArrayAdapter<CaptureDataModel> {

    Context context;
    List<CaptureDataModel> list;


    public PenjaminKualitasDataAdapter(Context context, List<CaptureDataModel> objects) {

        super(context, R.layout.row_penjamin_kualitas_data, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.row_penjamin_kualitas_data, null);
